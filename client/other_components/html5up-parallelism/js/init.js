			...
			init: function() {
				...
				// Skel.
					skel.init({
						...
						containers: '100%',
						breakpoints: {
							global: { range: '*', href: 'other_components/html5up-parallelism/css/style.css' },
							desktop: { range: '737-', href: 'other_components/html5up-parallelism/css/style-desktop.css', viewport: { width: 1280, scalable: false } },
							mobile: { range: '-736', href: 'other_components/html5up-parallelism/css/style-mobile.css', viewport: { scalable: false } }
						}
					});
